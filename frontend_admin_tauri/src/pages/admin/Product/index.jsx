            ...
            <section className="section">
                <div className="card">
                    <div className="card-header">
                        <button type="button" className="btn btn-primary btn-sm mb-3" data-bs-toggle="modal" data-bs-target="#product">
                                ...
                                {products &&
                                    products.map((row) => (
                                        <tr key={row.product_id}>
                                            ...
                                            <td width="250">
                                                <a href={`/admin/product/edit/${row.product_id}`} className="btn btn-success">
                                                    Edit
                                                </a>
                                                <button
                                                    onClick={handleDeleteProduct(id)}
                                                    href={`/admin/product/delete/${row.product_id}`}
